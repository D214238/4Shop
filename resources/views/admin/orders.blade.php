	...
	<table class="table table-striped table-hover">
		...
		@foreach($orders as $order)
			<tr>
				...
				<td>
					<a href="{{ route('admin.orders.toggle', $order) }}">{!! $order->delivered ? '<span class="badge badge-success">geleverd</span>' : '<span class="badge badge-warning">niet geleverd</span>' !!}</a>
				</td>
			</tr>
		@endforeach
	</table>
